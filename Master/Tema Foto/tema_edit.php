...
if (isset($_POST['update'])) {
    ...
    if (empty($nama_tema)) { $error = "Nama tema tidak boleh kosong!"; }
        ...
        if ($error == "") {
            ...
            if ($res) { $success = true; } else { $error = "Gagal memperbarui data!"; }
        }
    }
}
...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box; }
        ...
        .current-foto-box { background:rgba(255,255,255,0.12); border-radius:16px; overflow:hidden; }
        .current-foto-box img { width:100%; height:150px; object-fit:cover; display:block; }
        .current-foto-box .foto-label { padding:10px 14px; font-size:10px; opacity:0.7; font-weight:700; }
    ...
    <div class="main-card">
        ...
        <div class="form-side">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" name="update" class="btn btn-update"><i class="bi bi-check2-all me-2"></i>Simpan Perubahan</button>
                <div class="text-center mt-3"><a href="list.php" class="text-muted small text-decoration-none fw-bold">Kembali ke Daftar</a></div>
            </form>
        </div>
    </div>
</div>
