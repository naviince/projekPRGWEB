                ...
                <tbody>
                    ...
                    if (!empty($properti_list)):
                        foreach($properti_list as $row):
                            ...
                            // Menentukan class warna toggle berdasarkan status
                        ...
                        <tr class="fade-in-up">
                            ...
                            <td class="text-center-custom">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <!-- Tombol Toggle Status dengan Warna Dinamis -->
                                    <button class="btn-action-circle <?= $toggle_class ?>" 
                                            onclick="toggleStatus(<?= $row['ID_Properti'] ?>, <?= $row['Status'] ?>, '<?= htmlspecialchars($row['Nama_Properti']) ?>')" 
                                    ...
                                    <button class="btn-action-circle btn-action-delete" 
                                            onclick="hardDelete(<?= $row['ID_Properti'] ?>, '<?= htmlspecialchars($row['Nama_Properti']) ?>')" 
