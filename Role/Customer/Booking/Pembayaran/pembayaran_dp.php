...
// HITUNG DP 65%
// =====================================================
$harga_paket = (float)$d_order['Harga_Paket'];
...
$qris_data = [
    'foto' => '../../../../assets/img/qris/qris_spotlight.jpg',
    'atas_nama' => 'SpotLight Studio Foto'
];
...
$q_profile = sqlsrv_query($conn, 
    "SELECT Nama_Pelanggan, Foto_Profil FROM Pelanggan WHERE ID_Pelanggan = ? AND Status = ?", 
...
$deadline = $booking_time + (24 * 60 * 60); // 24 jam
$now = time();
        ...
        <div class="payment-section">
            ...
            <div>
                ...
                <div class="info-card">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">#<?= str_pad((int)$d_order['ID_Order'], 5, '0', STR_PAD_LEFT) ?></span>
                    </div>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><?= htmlspecialchars($tgl_str) ?> | <?= htmlspecialchars($jam_mulai_str) ?> - <?= htmlspecialchars($jam_selesai_str) ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Total Harga</span>
                        <span class="info-value total">Rp <?= $harga_format ?></span>
                    </div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="rekening-card" style="margin-bottom:12px;">
                        <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px;">
                            <i class="bi bi-bank" style="color:#0369a1;font-size:1.2rem;"></i>
                    ...
                    <?php endforeach; ?>
                    <?php else: ?>
                    <div style="padding:20px;background:#f8fafc;border-radius:12px;text-align:center;color:#718096;font-weight:600;">
                        <i class="bi bi-exclamation-circle" style="font-size:1.5rem;margin-bottom:8px;display:block;"></i>
                ...
                <div class="qris-card">
                    ...
                    <?php else: ?>
                        <div style="padding:40px 20px;background:linear-gradient(135deg,#f8fafc,#fff5f6);border-radius:16px;border:2px dashed var(--light-pink);text-align:center;margin-bottom:16px;">
                            ...
                            <div style="font-size:0.85rem;color:#94a3b8;margin-top:8px;">Hubungi admin untuk QRIS aktif</div>
                        </div>
                    <?php endif; ?>
                    <div class="qris-note">Scan QRIS di atas untuk pembayaran</div>
                    <div class="qris-note" style="margin-top: 4px; font-weight: 700; color: var(--p-pink);">a.n. <?= htmlspecialchars($qris_data['atas_nama']) ?></div>
                </div>
            </div>
            ...
            <div class="upload-card">
                ...
                <div class="dp-amount">
                    ...
                    <div class="dp-amount-note">Sisa pembayaran Rp <?= $sisa_format ?> setelah sesi selesai</div>
                </div>
